...
o novo sistema de cadastro, e pediram a sua ajuda. Sua task é fazer o 
código que valide as senhas que são cadastradas, para isso você deve 
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while(true)
            {
                ...
                Match conf = Regex.Match(senha, pattern);
                if(conf.Success)
                {
